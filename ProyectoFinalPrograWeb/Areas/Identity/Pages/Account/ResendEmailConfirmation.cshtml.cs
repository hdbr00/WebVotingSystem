...
namespace ProyectoFinalPrograWeb.Areas.Identity.Pages.Account
{
    ...
    public class ResendEmailConfirmationModel : PageModel
    {
        ...
        {
            [Required (ErrorMessage = "El campo de correo no es una dirección de correo electrónico válida")]
            [EmailAddress]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            await _emailSender.SendEmailAsync(
                Input.Email,
                "Confirme su correo",
                $"Por favor confirme el correo: <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clic aquí</a>.");
